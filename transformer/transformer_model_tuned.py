...
class Seq2SeqTransformer(nn.Module):
    def __init__(self, num_encoder_layers, num_decoder_layers,
        ...
        # Store hyperparams (useful for logging)
    ...
    def forward(self, src, tgt, *args, **kwargs):
        ...
        Accepts extra args (e.g. teacher_forcing_ratio) for compatibility
        with logger/evaluate, but ignores them.
        """
        device = src.device
